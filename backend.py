"""
backend.py — MindTrack Mental Health Monitor
=============================================================================
Run with:
...
WELLNESS_TIPS = [
    "Take a 5-minute walk outside — fresh air clears the mind.",
    ...
    "Eat something nutritious — your brain needs fuel!",
    ...
    "Get 7-8 hours of sleep tonight — it's medicine.",
...
app = FastAPI(
    ...
    description="Student mental health tracking backend — single file version",
    version="1.0.0",
)
...
FALLBACK_RESPONSES = [
    "I hear you. It sounds like you're going through a tough time. Remember, it's okay to not be okay sometimes. 💙",
    "Thank you for sharing that with me. Taking small steps is still moving forward — you've got this!",
    "That sounds really difficult. Have you tried taking a few slow, deep breaths? It can help calm the mind.",
    "You're not alone in feeling this way. Many students experience the same pressure. Be kind to yourself today. 🌸",
    "It's brave of you to talk about how you feel. Consider reaching out to a counsellor if things feel overwhelming.",
    "Progress isn't always linear. It's okay to have bad days — what matters is you keep going. 🌟",
...
RECOMMENDATIONS = {
    ...
    "High": [
        ...
        "Prioritise rest — your wellbeing matters more than grades.",
    ],
}
...
def emergency_resources():
    return {
        "resources": [
            {"name": "iCall (India)",         "number": "9152987821",    "description": "Free psychosocial support helpline by TISS",   "hours": "Mon–Sat, 8am–10pm"},
            ...
            {"name": "iCall WhatsApp",        "number": "+919152987821", "description": "WhatsApp support by iCall",                   "hours": "Mon–Sat, 8am–10pm"},
            {"name": "Snehi",                 "number": "044-24640050",  "description": "Emotional support and suicide prevention",    "hours": "24 hours"},
        ],
        "message": "You are not alone. Reaching out for help is a sign of strength. 💙",
    }
...
def log_study_stress(entry: StudyStressEntry, authorization: str = Header(None)):
    ...
    if stress_score <= 5:
        ...
        advice = [
            ...
            "Make sure you're getting at least 6–7 hours of sleep.",
        ]
    else:
        level = "High"
        advice = [
            ...
            "Sleep is more important than cramming — a rested brain learns faster.",
            "Ask a classmate for help — collaboration is not cheating!",
        ]
